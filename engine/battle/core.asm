...
DrawPlayerHUD:
	...
	; load the address of partymon1's experience into de
	ld a, [wCurBattleMon]
...
GiveExperiencePoints:; Give experience.
...
.loop1
	ld a, b			; number of pixels of hp left to draw passed from b
