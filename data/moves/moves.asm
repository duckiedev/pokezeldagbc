...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move KARATE_CHOP,  EFFECT_NORMAL_HIT,         50, WARRIOR,     100, 25,   0
	...
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         35, FOREST,        100, 10,   0
	move STOMP,        EFFECT_STOMP,              65, NORMAL,       100, 20,  30
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, WARRIOR,     100, 30,   0
	move MEGA_KICK,    EFFECT_NORMAL_HIT,        120, NORMAL,        75,  5,   0
	move JUMP_KICK,    EFFECT_JUMP_KICK,          70, WARRIOR,      95, 25,   0
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         60, WARRIOR,      85, 15,  30
	...
	move SUBMISSION,   EFFECT_RECOIL_HIT,         80, WARRIOR,      80, 25,   0
	move LOW_KICK,     EFFECT_FLINCH_HIT,         50, WARRIOR,      90, 20,  30
	move COUNTER,      EFFECT_COUNTER,             1, WARRIOR,     100, 20,   0
	move SEISMIC_TOSS, EFFECT_LEVEL_DAMAGE,        1, WARRIOR,     100, 20,   0
	move STRENGTH,     EFFECT_NORMAL_HIT,         80, NORMAL,       100, 15,   0
	move ABSORB,       EFFECT_LEECH_HIT,          20, FOREST,        100, 20,   0
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          40, FOREST,        100, 10,   0
	move LEECH_SEED,   EFFECT_LEECH_SEED,          0, FOREST,         90, 10,   0
	move GROWTH,       EFFECT_SP_ATK_UP,           0, NORMAL,       100, 40,   0
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         55, FOREST,         95, 25,   0
	move SOLARBEAM,    EFFECT_SOLARBEAM,         120, FOREST,        100, 10,   0
	move POISONPOWDER, EFFECT_POISON,              0, POISON,        75, 35,   0
	move STUN_SPORE,   EFFECT_PARALYZE,            0, FOREST,         75, 30,   0
	move SLEEP_POWDER, EFFECT_SLEEP,               0, FOREST,         75, 15,   0
	move PETAL_DANCE,  EFFECT_RAMPAGE,            70, FOREST,        100, 20,   0
	...
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,          85, WARRIOR,      90, 20,   0
	...
	move SPORE,        EFFECT_SLEEP,               0, FOREST,        100, 15,   0
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        10, WARRIOR,      90, 10,   0
	...
	move COTTON_SPORE, EFFECT_SPEED_DOWN_2,        0, FOREST,         85, 40,   0
	move REVERSAL,     EFFECT_REVERSAL,            1, WARRIOR,     100, 15,   0
	...
	move MACH_PUNCH,   EFFECT_PRIORITY_HIT,       40, WARRIOR,     100, 30,   0
	...
	move DETECT,       EFFECT_PROTECT,             0, WARRIOR,     100,  5,   0
	...
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          60, FOREST,        100,  5,   0
	...
	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        10, WARRIOR,       95, 20,   0
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       100, WARRIOR,      50,  5, 100
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   20, WARRIOR,     100, 15,  50
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        15, WATER,         70, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            10, DARK,         100, 10,   0
	move BOMBARD,      EFFECT_NORMAL_HIT,        100, NORMAL,        75, 10,   0
