...
; SPRITE_ANIM_OBJ_BOMB
	db SPRITE_ANIM_FRAMESET_BOMB,         			   SPRITE_ANIM_FUNC_BOMB,      				   SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_OBJ_TREASUREITEM
	db SPRITE_ANIM_FRAMESET_TREASUREITEM,              SPRITE_ANIM_FUNC_TREASUREITEM,              SPRITE_ANIM_DICT_DEFAULT
