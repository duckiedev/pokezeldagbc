...
MapGroup_Forest:
	...
	map ForestAreaF7, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map ForestAreaF8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map ForestAreaG7, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestAreaG8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestAreaH7, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestAreaH8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestAreaI8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestAreaN4, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestAreaN5, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	assert_table_length NUM_FOREST_MAPS

MapGroup_Beach:
	table_width MAP_LENGTH, MapGroup_Beach
	map BeachAreaJ8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaK8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaL8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaM8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaN3, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaN8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaO3, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaO4, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaO8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaP4, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaP5, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaP6, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaP7, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BeachAreaP8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
