...
MapGroup_Forest:
	...
	map ForestStartingArea, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestAreaF7, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map ForestAreaF8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map ForestAreaG7, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestAreaG8, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	map ForestAreaH7, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_AUTO, FISHGROUP_NONE
