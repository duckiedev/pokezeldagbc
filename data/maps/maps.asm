...
MapGroup_Forest:
	...
	map ForestAreaH8, TILESET_OVERWORLD_MAIN, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map ForestZone01, TILESET_OVERWORLD_MAIN, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_ZELDA_TITLE, TRUE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Cave:
	...
	map CaveH8, TILESET_CAVE_MAIN, CAVE, LANDMARK_NEW_BARK_TOWN, MUSIC_CAVE_THEME, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map GateOfTime, TILESET_GATE_OF_TIME, CAVE, LANDMARK_NEW_BARK_TOWN, MUSIC_GATE_OF_TIME, TRUE, PALETTE_AUTO, FISHGROUP_NONE
	assert_table_length NUM_CAVE_MAPS

MapGroup_HeroesCave:
	table_width MAP_LENGTH, MapGroup_HeroesCave
	map HeroesCave01, TILESET_CAVE_MAIN, DUNGEON, LANDMARK_NEW_BARK_TOWN, MUSIC_CAVE_THEME, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map HeroesCave02, TILESET_CAVE_MAIN, DUNGEON, LANDMARK_NEW_BARK_TOWN, MUSIC_CAVE_THEME, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map HeroesCave03, TILESET_CAVE_MAIN, DUNGEON, LANDMARK_NEW_BARK_TOWN, MUSIC_NONE, TRUE, PALETTE_DAY, FISHGROUP_NONE
