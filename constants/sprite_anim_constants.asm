...
; SpriteAnimObjects indexes (see data/sprite_anims/objects.asm)
	...
	const SPRITE_ANIM_OBJ_MAGNET_TRAIN	            ; 14
	const SPRITE_ANIM_OBJ_LEAF                      ; 15
	const SPRITE_ANIM_OBJ_CUT_TREE                  ; 16
	const SPRITE_ANIM_OBJ_FLY_LEAF                  ; 17
	const SPRITE_ANIM_OBJ_EGG_CRACK                 ; 18
	const SPRITE_ANIM_OBJ_GS_INTRO_HO_OH_LUGIA      ; 19
	const SPRITE_ANIM_OBJ_HEADBUTT                  ; 1a
	const SPRITE_ANIM_OBJ_EGG_HATCH                 ; 1b
	const SPRITE_ANIM_OBJ_BLUE_WALK                 ; 1c
	const SPRITE_ANIM_OBJ_INTRO_SUICUNE             ; 1d
	const SPRITE_ANIM_OBJ_INTRO_PICHU               ; 1e
	const SPRITE_ANIM_OBJ_INTRO_WOOPER              ; 1f
	const SPRITE_ANIM_OBJ_INTRO_UNOWN               ; 20
	const SPRITE_ANIM_OBJ_INTRO_UNOWN_F             ; 21
	const SPRITE_ANIM_OBJ_INTRO_SUICUNE_AWAY        ; 22
	const SPRITE_ANIM_OBJ_CELEBI                    ; 23
	const SPRITE_ANIM_OBJ_BOMB						; 24
	const SPRITE_ANIM_OBJ_TREASUREITEM              ; 25
...
; DoSpriteAnimFrame.Jumptable indexes (see engine/sprite_anims/functions.asm)
	...
	const SPRITE_ANIM_FUNC_CUT_LEAVES                ; 14
	const SPRITE_ANIM_FUNC_FLY_FROM                  ; 15
	const SPRITE_ANIM_FUNC_FLY_LEAF                  ; 16
	const SPRITE_ANIM_FUNC_FLY_TO                    ; 17
	const SPRITE_ANIM_FUNC_GS_INTRO_HO_OH_LUGIA      ; 18
	const SPRITE_ANIM_FUNC_INTRO_SUICUNE             ; 19
	const SPRITE_ANIM_FUNC_INTRO_PICHU_WOOPER        ; 1a
	const SPRITE_ANIM_FUNC_CELEBI                    ; 1b
	const SPRITE_ANIM_FUNC_INTRO_UNOWN               ; 1c
	const SPRITE_ANIM_FUNC_INTRO_UNOWN_F             ; 1d
	const SPRITE_ANIM_FUNC_INTRO_SUICUNE_AWAY        ; 1e
	const SPRITE_ANIM_FUNC_BOMB						 ; 1f
	const SPRITE_ANIM_FUNC_TREASUREITEM				 ; 20
...
; SpriteAnimFrameData indexes (see data/sprite_anims/framesets.asm)
	...
	const SPRITE_ANIM_FRAMESET_PARTY_MON_WITH_ITEM       ; 02
	const SPRITE_ANIM_FRAMESET_PARTY_MON_FAST            ; 03
	const SPRITE_ANIM_FRAMESET_PARTY_MON_WITH_ITEM_FAST  ; 04
	const SPRITE_ANIM_FRAMESET_GS_TITLE_TRAIL            ; 05
	const SPRITE_ANIM_FRAMESET_TEXT_ENTRY_CURSOR         ; 06
	const SPRITE_ANIM_FRAMESET_TEXT_ENTRY_CURSOR_BIG     ; 07
	const SPRITE_ANIM_FRAMESET_GAMEFREAK_LOGO            ; 08
	const SPRITE_ANIM_FRAMESET_GS_GAMEFREAK_LOGO_STAR    ; 09
	const SPRITE_ANIM_FRAMESET_GS_GAMEFREAK_LOGO_SPARKLE ; 0a
	const SPRITE_ANIM_FRAMESET_SLOTS_GOLEM               ; 0b
	const SPRITE_ANIM_FRAMESET_SLOTS_CHANSEY             ; 0c
	const SPRITE_ANIM_FRAMESET_SLOTS_CHANSEY_2           ; 0d
	const SPRITE_ANIM_FRAMESET_SLOTS_EGG                 ; 0e
	const SPRITE_ANIM_FRAMESET_RED_WALK                  ; 0f
	const SPRITE_ANIM_FRAMESET_STILL_CURSOR              ; 10
	const SPRITE_ANIM_FRAMESET_TRADE_POKE_BALL           ; 11
	const SPRITE_ANIM_FRAMESET_TRADE_POKE_BALL_WOBBLE    ; 12
	const SPRITE_ANIM_FRAMESET_TRADE_POOF                ; 13
	const SPRITE_ANIM_FRAMESET_TRADE_TUBE_BULGE          ; 14
	const SPRITE_ANIM_FRAMESET_TRADEMON_ICON             ; 15
	const SPRITE_ANIM_FRAMESET_TRADEMON_BUBBLE           ; 16
	const SPRITE_ANIM_FRAMESET_EVOLUTION_BALL_OF_LIGHT   ; 17
	const SPRITE_ANIM_FRAMESET_MAGNET_TRAIN              ; 18
	...
	const SPRITE_ANIM_FRAMESET_GS_INTRO_HO_OH_LUGIA      ; 21
	const SPRITE_ANIM_FRAMESET_HEADBUTT                  ; 22
	const SPRITE_ANIM_FRAMESET_BLUE_WALK                 ; 23
	const SPRITE_ANIM_FRAMESET_INTRO_SUICUNE             ; 24
	const SPRITE_ANIM_FRAMESET_INTRO_SUICUNE_2           ; 25
	const SPRITE_ANIM_FRAMESET_INTRO_PICHU               ; 26
	const SPRITE_ANIM_FRAMESET_INTRO_WOOPER              ; 27
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_1             ; 28
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_2             ; 29
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_3             ; 2a
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_4             ; 2b
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_F_2           ; 2c
	const SPRITE_ANIM_FRAMESET_INTRO_SUICUNE_AWAY        ; 2d
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_F             ; 2e
	const SPRITE_ANIM_FRAMESET_CELEBI_LEFT               ; 2f
	const SPRITE_ANIM_FRAMESET_CELEBI_RIGHT              ; 30
	const SPRITE_ANIM_FRAMESET_BOMB						 ; 31
	const SPRITE_ANIM_FRAMESET_TREASUREITEM				 ; 32
...
; SpriteAnimOAMData indexes (see data/sprite_anims/oam.asm)
	...
	const SPRITE_ANIM_OAMSET_PARTY_MON_WITH_ITEM_1       ; 3c
	const SPRITE_ANIM_OAMSET_PARTY_MON_WITH_ITEM_2       ; 3d
	const SPRITE_ANIM_OAMSET_MAGNET_TRAIN_1              ; 3e
	const SPRITE_ANIM_OAMSET_MAGNET_TRAIN_2              ; 3f
	const SPRITE_ANIM_OAMSET_UNUSED_43                   ; 40
	const SPRITE_ANIM_OAMSET_UNUSED_44                   ; 41
	const SPRITE_ANIM_OAMSET_UNUSED_45                   ; 42
	const SPRITE_ANIM_OAMSET_UNUSED_46                   ; 43
	const SPRITE_ANIM_OAMSET_UNUSED_47                   ; 44
	const SPRITE_ANIM_OAMSET_UNUSED_48                   ; 45
	const SPRITE_ANIM_OAMSET_UNUSED_49                   ; 46
	const SPRITE_ANIM_OAMSET_UNUSED_4A                   ; 47
	const SPRITE_ANIM_OAMSET_UNUSED_4B                   ; 48
	const SPRITE_ANIM_OAMSET_UNUSED_4C                   ; 49
	const SPRITE_ANIM_OAMSET_UNUSED_4D                   ; 4a
	const SPRITE_ANIM_OAMSET_UNUSED_4E                   ; 4b
	const SPRITE_ANIM_OAMSET_LEAF                        ; 4c
	const SPRITE_ANIM_OAMSET_TREE_1                      ; 4d
	const SPRITE_ANIM_OAMSET_CUT_TREE_2                  ; 4e
	const SPRITE_ANIM_OAMSET_CUT_TREE_3                  ; 4f
	const SPRITE_ANIM_OAMSET_CUT_TREE_4                  ; 50
	const SPRITE_ANIM_OAMSET_EGG_CRACK                   ; 51
	const SPRITE_ANIM_OAMSET_EGG_HATCH                   ; 52
	const SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_LUGIA_1      ; 53
	const SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_LUGIA_2      ; 54
	const SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_LUGIA_3      ; 55
	const SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_LUGIA_4      ; 56
	const SPRITE_ANIM_OAMSET_GS_INTRO_HO_OH_LUGIA_5      ; 57
	const SPRITE_ANIM_OAMSET_HEADBUTT_TREE_2             ; 58
	const SPRITE_ANIM_OAMSET_BLUE_WALK_1                 ; 59
	const SPRITE_ANIM_OAMSET_BLUE_WALK_2                 ; 5a
	const SPRITE_ANIM_OAMSET_INTRO_SUICUNE_1             ; 5b
	const SPRITE_ANIM_OAMSET_INTRO_SUICUNE_2             ; 5c
	const SPRITE_ANIM_OAMSET_INTRO_SUICUNE_3             ; 5d
	const SPRITE_ANIM_OAMSET_INTRO_SUICUNE_4             ; 5e
	const SPRITE_ANIM_OAMSET_INTRO_PICHU_1               ; 5f
	const SPRITE_ANIM_OAMSET_INTRO_PICHU_2               ; 60
	const SPRITE_ANIM_OAMSET_INTRO_PICHU_3               ; 61
	const SPRITE_ANIM_OAMSET_INTRO_WOOPER                ; 62
	const SPRITE_ANIM_OAMSET_INTRO_UNOWN_1               ; 63
	const SPRITE_ANIM_OAMSET_INTRO_UNOWN_2               ; 64
	const SPRITE_ANIM_OAMSET_INTRO_UNOWN_3               ; 65
	const SPRITE_ANIM_OAMSET_INTRO_UNOWN_F_2_1           ; 66
	const SPRITE_ANIM_OAMSET_INTRO_UNOWN_F_2_2           ; 67
	const SPRITE_ANIM_OAMSET_INTRO_UNOWN_F_2_3           ; 68
	const SPRITE_ANIM_OAMSET_INTRO_UNOWN_F_2_4           ; 69
	const SPRITE_ANIM_OAMSET_INTRO_UNOWN_F_2_5           ; 6a
	const SPRITE_ANIM_OAMSET_INTRO_SUICUNE_AWAY          ; 6b
	const SPRITE_ANIM_OAMSET_CELEBI_1                    ; 6c
	const SPRITE_ANIM_OAMSET_CELEBI_2                    ; 6d
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_1            ; 6e
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_2            ; 6f
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_3            ; 70
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_4            ; 71
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_5            ; 72
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_6            ; 73
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_7            ; 74
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_8            ; 75
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_9            ; 76
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_10           ; 77
	const SPRITE_ANIM_OAMSET_GAMEFREAK_LOGO_11           ; 78
	const SPRITE_ANIM_OAMSET_PARTY_MON_1                 ; 79
	const SPRITE_ANIM_OAMSET_PARTY_MON_2                 ; 7a
	const SPRITE_ANIM_OAMSET_BOMB						 ; 7b
	const SPRITE_ANIM_OAMSET_TREASUREITEM				 ; 7c
