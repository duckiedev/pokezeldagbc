...
; SpriteAnimFrameData indexes (see data/sprite_anims/framesets.asm)
	...
	const SPRITE_ANIM_FRAMESET_BLUE_WALK                 ; 26
	const SPRITE_ANIM_FRAMESET_MAGNET_TRAIN_BLUE         ; 27
	const SPRITE_ANIM_FRAMESET_INTRO_SUICUNE             ; 28
	const SPRITE_ANIM_FRAMESET_INTRO_SUICUNE_2           ; 29
	const SPRITE_ANIM_FRAMESET_INTRO_PICHU               ; 2a
	const SPRITE_ANIM_FRAMESET_INTRO_WOOPER              ; 2b
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_1             ; 2c
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_2             ; 2d
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_3             ; 2e
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_4             ; 2f
	const SPRITE_ANIM_FRAMESET_INTRO_UNOWN_F_2           ; 30
	const SPRITE_ANIM_FRAMESET_INTRO_SUICUNE_AWAY        ; 31
