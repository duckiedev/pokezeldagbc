; SFX indexes (see audio/sfx_pointers.asm)
	...
	const SFX_MOVE_DELETED                ; 94
	const SFX_2ND_PLACE                   ; 95
	const SFX_1ST_PLACE                   ; 96
	const SFX_CHOOSE_A_CARD               ; 97
	const SFX_GET_TM                      ; 98
	const SFX_GET_BADGE                   ; 99
	const SFX_QUIT_SLOTS                  ; 9a
	const SFX_DEX_FANFARE_LESS_THAN_20    ; 9b
	const SFX_DEX_FANFARE_140_169         ; 9c
	const SFX_DEX_FANFARE_170_199         ; 9e
	const SFX_DEX_FANFARE_200_229         ; 9f
	const SFX_DEX_FANFARE_230_PLUS        ; a0
	const SFX_EVOLVED                     ; a1
	const SFX_MASTER_BALL                 ; a2
	const SFX_GS_INTRO_CHARIZARD_FIREBALL ; a3
	const SFX_GS_INTRO_POKEMON_APPEARS    ; a4
	const SFX_FLASH                       ; a6
	const SFX_GAME_FREAK_LOGO_GS          ; a7
	const SFX_NOT_VERY_EFFECTIVE          ; a8
	const SFX_DAMAGE                      ; a9
	const SFX_SUPER_EFFECTIVE             ; aa
	const SFX_BALL_BOUNCE                 ; ab
	const SFX_MOONLIGHT                   ; ac
	const SFX_ENCORE                      ; ad
	const SFX_BEAT_UP                     ; ae
	const SFX_BATON_PASS                  ; af
	const SFX_BALL_WOBBLE                 ; b0
	const SFX_SWEET_SCENT                 ; b1
	const SFX_SWEET_SCENT_2               ; b2
	const SFX_HIT_END_OF_EXP_BAR          ; b3
	const SFX_GIVE_TRADEMON               ; b4
	const SFX_GET_TRADEMON                ; b5
	const SFX_TRAIN_ARRIVED               ; b6
	const SFX_STOP_SLOT                   ; b7
	const SFX_2_BOOPS                     ; b8
; new to Crystal
	const SFX_GLASS_TING                  ; b9
	const SFX_GLASS_TING_2                ; ba
	const SFX_INTRO_UNOWN_1               ; bb
	const SFX_INTRO_UNOWN_2               ; bc
	const SFX_INTRO_UNOWN_3               ; bd
	const SFX_DITTO_POP_UP                ; be
	const SFX_DITTO_TRANSFORM             ; bf
	const SFX_INTRO_SUICUNE_1             ; c0
	const SFX_INTRO_PICHU                 ; c1
	const SFX_INTRO_SUICUNE_2             ; c2
	const SFX_INTRO_SUICUNE_3             ; c3
	const SFX_DITTO_BOUNCE                ; c4
	const SFX_INTRO_SUICUNE_4             ; c5
	const SFX_GAME_FREAK_PRESENTS         ; c6
	const SFX_TINGLE                      ; c7
	const SFX_INTRO_WHOOSH                ; c8
	const SFX_TWO_PC_BEEPS                ; c9
	const SFX_4_NOTE_DITTY                ; ca
	const SFX_TWINKLE                     ; cb
; Zelda
	const SFX_TEXT_PRINT				  ; cc
	const SFX_TEXT_PRINT_DONE			  ; cd
	const SFX_SOLVE_PUZZLE				  ; ce
	const SFX_GET_ITEM					  ; cf
	const SFX_MENU_MOVE					  ; d0
	const SFX_SELECT_ITEM				  ; d1
	const SFX_PUDDLE					  ; d2
