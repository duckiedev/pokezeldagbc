...
; HMs (EVENT_GOT_HM07_WATERFALL is with the Johto itemballs)
	...
	const EVENT_TREASURECHEST_HEROESCAVE02
; Rods
...
; Zelda
	const EVENT_CAVEH8_OLDMAN_INTRO
	const EVENT_CAVEH8_HIDDEN_DOOR_REVEALED
	const EVENT_BEAT_ITTIBAT_HEROES_CAVE_02
	const EVENT_BEAT_ZOL_01_HEROES_CAVE_03
	const EVENT_BEAT_ZOL_02_HEROES_CAVE_03
	const EVENT_BEAT_ZOL_03_HEROES_CAVE_03
	const EVENT_HEROES_CAVE_02_TREASURE_CHEST_OPENED
	const EVENT_GOT_KINSTONE_OCARINA
