...
DEF TEXTBOX_WIDTH  EQU SCREEN_WIDTH - BORDER_WIDTH
...
DEF TEXTBOX_Y      EQU SCREEN_HEIGHT - TEXTBOX_HEIGHT - 1
...
; blinking cursor
DEF BLINKING_CURSOR_X EQU 18
DEF BLINKING_CURSOR_Y EQU 16
