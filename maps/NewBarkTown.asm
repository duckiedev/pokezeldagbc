...
NewBarkTown_MapEvents:
	...
	def_warp_events
	warp_event  2,  1, ELMS_LAB, 1
	warp_event  9,  3, PLAYERS_HOUSE_1F, 1
	warp_event -1,  9, PLAYERS_NEIGHBORS_HOUSE, 1
	warp_event  7, 11, ELMS_HOUSE, 1

	def_coord_events
	coord_event -3,  6, SCENE_NEWBARKTOWN_TEACHER_STOPS_YOU, NewBarkTown_TeacherStopsYouScene1
	coord_event -3,  7, SCENE_NEWBARKTOWN_TEACHER_STOPS_YOU, NewBarkTown_TeacherStopsYouScene2

	def_bg_events
	bg_event  4,  6, BGEVENT_READ, NewBarkTownSign
	bg_event  7,  3, BGEVENT_READ, NewBarkTownPlayersHouseSign
	bg_event -1,  1, BGEVENT_READ, NewBarkTownElmsLabSign
	bg_event  5, 11, BGEVENT_READ, NewBarkTownElmsHouseSign

	def_object_events
	object_event  2,  6, SPRITE_TEACHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NewBarkTownTeacherScript, -1
	object_event  8,  7, SPRITE_FISHER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, NewBarkTownFisherScript, -1
	object_event -1,  0, SPRITE_RIVAL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NewBarkTownRivalScript, EVENT_RIVAL_NEW_BARK_TOWN
