...
NewBarkTown_MapEvents:
	...
	def_bg_events
	bg_event  9,  8, BGEVENT_READ, NewBarkTownSign
	...
	object_event  7,  7, SPRITE_FISHER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, NewBarkTownFisherScript, -1
