...
BoombloomFrontpic:   INCBIN "gfx/pokemon/boombloom/front.animated.2bpp.lz"
...
IttibatFrontpic:       INCBIN "gfx/pokemon/ittibat/front.animated.2bpp.lz"
KimonoGirlPic:       INCBIN "gfx/trainers/kimono_girl.2bpp.lz"
AlakazamBackpic:     INCBIN "gfx/pokemon/alakazam/back.2bpp.lz"
IgnizolFrontpic:       INCBIN "gfx/pokemon/ignizol/front.animated.2bpp.lz"
...
IttibatBackpic:        INCBIN "gfx/pokemon/ittibat/back.2bpp.lz"
...
BoombloomBackpic:    INCBIN "gfx/pokemon/boombloom/back.2bpp.lz"
...
IgnizolBackpic:        INCBIN "gfx/pokemon/ignizol/back.2bpp.lz"
