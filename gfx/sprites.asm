...
IttibatSpriteGFX::             INCBIN "gfx/sprites/ittibat.2bpp"
ZolSpriteGFX::                 INCBIN "gfx/sprites/zol.2bpp"
ChrisRunSpriteGFX::            INCBIN "gfx/sprites/chris_run.2bpp"
KrisRunSpriteGFX::             INCBIN "gfx/sprites/kris_run.2bpp"
NothingSpriteGFX::             INCBIN "gfx/sprites/nothing.2bpp"
IgnizolSpriteGFX::             INCBIN "gfx/sprites/ignizol.2bpp"
